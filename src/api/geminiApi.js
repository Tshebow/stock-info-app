...
export const geminiApi = {
  get: (tickerData) => client.models.generateContent({
    ...
    config: {
      systemInstruction: "You are a stock option advisor. The input will be a ticker data response from polygon API for a given day. Interpret the input into a simple report of max 300 lines.",
    }
  })
};